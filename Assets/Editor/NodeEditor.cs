...
{    
    ...
    public override void OnInspectorGUI()
    {
        ...
        Undo.RecordObjects(Selection.transforms, "Move " + ((Selection.transforms.Length != 1) ? string.Empty : Selection.activeGameObject.name));
        ...
        if (node != null)
        {
            ...
            else if (node.NodeCollection != null &&
            ...
            if (node.Graph != null &&
                node.Graph.nodeCollectionObject != null &&
            ...
            {    
                ...
                {
                    Node.ConnectNodes(System.Array.ConvertAll(Selection.GetFiltered(typeof(Node), SelectionMode.TopLevel), element => (Node)element));
                }
                ...
                {
                    Node.DisconnectNodes(System.Array.ConvertAll(Selection.GetFiltered(typeof(Node), SelectionMode.TopLevel), element => (Node)element));
                }
                ...
                if (GUILayout.Button("Cycle connection between two selected nodes"))
                {
                    ...
                    {
                        Node fromNode = (Node) filtered[0];
                        Node toNode = (Node) filtered[1];
