    ...
    public class ScoredNode : IEquatable<ScoredNode>, IShowable, IFormattable
    {
        ...
        public bool Equals(ScoredNode other)
        {
            return ((node == null) ? (other.node == null) : node.Equals(other.node)) && 
                f.Equals(other.f) && 
                g.Equals(other.g) &&
                ((edgeFromParent == null) ? (other.edgeFromParent == null) : edgeFromParent.Equals(other.edgeFromParent)) &&
                ((parentScoredNode == null) ? (other.parentScoredNode == null) : parentScoredNode.Equals(other.parentScoredNode));
        }
        ...
        {
            int num = (node == null) ? 0 : node.GetHashCode();
        ...
        {
            return string.Format("({0}, {1}, {2}, {3}, {4})", new object[] { node, f, g, edgeFromParent, parentScoredNode });
        }
        ...
        {
            return Showing.ShowString((ScoredNode) this, format, formatProvider);
        }
    }
}