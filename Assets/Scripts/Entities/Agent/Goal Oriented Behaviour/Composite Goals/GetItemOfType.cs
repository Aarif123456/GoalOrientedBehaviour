namespace GameBrains.AI
{
    ...
    public class GetItemOfType : CompositeGoal
    {
        ...
        public override void Activate()
        {
            ...
            EventManager.Instance.Enqueue<PathToItemRequestEventPayload>(
        ...
        {    
            PathToItemReadyEventPayload payload = eventArg.EventData;
        ...
        {    
            NoPathToItemAvailableEventPayload payload = eventArg.EventData;
